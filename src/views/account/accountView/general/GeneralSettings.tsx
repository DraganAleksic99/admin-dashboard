...
const GeneralSettings = ({user, ...rest}: Props) => {
                        ...
                        <CardContent>
                            <Grid container spacing={4}>
                                ...
                                <Grid item md={6} xs={12}>
                                    ...
                                    <Typography variant="body2" color="textSecondary">Means that anyone 
                                        viewing your profile will be able to see your contacts details
                                    </Typography>
                                    <Switch
